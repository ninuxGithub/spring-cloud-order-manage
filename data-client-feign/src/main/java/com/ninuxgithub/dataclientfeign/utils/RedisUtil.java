package com.ninuxgithub.dataclientfeign.utils;
...
public class RedisUtil {
     ...
     * @return
     */
    public boolean persistData(String key, Object value) {
        boolean result = true;
        try {
            result = set(key, JsonUtil.writeValueAsString(value), 300, TimeUnit.SECONDS);
        } catch (Exception e) {
            e.printStackTrace();
            result = false;
            logger.error("redis持久化key:{}出现了异常{}", key, e.getMessage());
        }
        return result;
    }
    ...
    public boolean set(final String key, final String value, long timeout, TimeUnit unit) {
        ...
        logger.info("set key:  {}  timeout:{}  expire :{}", key, timeout, result);
        return result;
    }
