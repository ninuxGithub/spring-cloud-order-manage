...
public class RabbitServerConfirmCallback implements ConfirmCallback, ReturnCallback {
	private static final Logger logger = LoggerFactory.getLogger(RabbitServerConfirmCallback.class);
